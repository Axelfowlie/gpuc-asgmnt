...
silent only
cd /media/hakononakani/Storage/uni/gpuc/gpuc-asgmnt/Assignment4
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 Assignment4/CAssignment4.cpp
badd +0 Assignment4/main.cpp
badd +1 Assignment4/CParticleSystemTask.h
badd +0 Assignment4/CParticleSystemTask.cpp
badd +0 Assignment4/ParticleSystem.cl
badd +0 Assignment4/particles.vert
badd +0 Assignment4/Scan.cl
argglobal
silent! argdel *
